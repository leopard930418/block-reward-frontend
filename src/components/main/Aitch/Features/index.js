    ...
    <LandingLayout>
      <Container id="features">
        ...
        <RightWrapper data-aos='fade-up' data-aos-delay="200">
          ...
          <h1>Mystery Box Collectibles</h1>
          <p>The collection consists of 16 different collectible digital trading cards & artworks representing the songs on Aitch's new album. For each purchase you will receive one of the 16 digital trading cards & art pieces. Each collectible comes with the chance to win one of 47 super rare real life perks. The winners will be revealed once the collection is sold out and prizes include:</p>
          <ItemContainer>
            <CheckItem>
              <BsCheckCircle />
